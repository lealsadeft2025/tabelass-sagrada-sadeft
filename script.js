/* SADEFT LEAL — script.js (final atualizado) */
/* util */
...
function renderResultado(res){
  ...
  res.jogos.forEach(j=>{
    ...
    const right = document.createElement("div"); right.style.textAlign="right"; right.innerHTML = `<div style="color:#ffd700;font-weight
